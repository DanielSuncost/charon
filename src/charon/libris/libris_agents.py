...
def start_autonomous_libris_research(
    ...
    *,
    ...
    from charon.libris.libris_runtime import init_operation, update_operation_runtime
    ...
    try:
        ...
        for t in selected:
            ...
            try:
                ...
                if procurement_md:
                    from charon.libris.libris_runtime import save_evidence
                    save_evidence(
...
def _run_libris_role(
    ...
    try:
        ...
        from charon.context.system_prompt_builder import build_system_prompt
        from charon.libris.libris_runtime import record_usage, append_operation_event, get_operation_state, emit_agent_phase
        from charon.providers.worker_provider import request_worker_provider_for_background_flow
        ...
        try:
            from charon.libris.libris_runtime import append_operation_event, emit_agent_phase
            emit_agent_phase(
                state_dir, project_root, operation_id,
                agent_id=agent.get('id', ''), role=role,
