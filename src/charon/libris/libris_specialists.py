...
def spawn_topic_claim_extraction_shades(
    ...
    *,
    ...
    from charon.libris.libris_runtime import list_promising_sources, append_operation_event, emit_agent_comm, emit_agent_phase
...
def spawn_topic_contradiction_check_shades(
    ...
    *,
    ...
    from charon.libris.libris_runtime import append_operation_event, emit_agent_comm, emit_agent_phase
    from charon.libris.libris_orchestrator import _tool_ctx
    from charon.tools.shade_tool import execute_spawn_shade
...
def ingest_contradiction_check_contracts(
    ...
    from charon.libris.libris_runtime import list_topic_contracts, summarize_contract_for_swarm, save_evidence, append_operation_event
