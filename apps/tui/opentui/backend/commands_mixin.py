...
{'cmd': '/setup effort <level>', 'desc': 'Reasoning effort for this session: off minimal low medium high xhigh max ultra'},
            ...
            {'cmd': '/effort', 'desc': 'Show or set reasoning effort (off … ultra; the current model\'s ladder is shown)'},
            ...
            {'cmd': '/libris status [operation_id]', 'desc': 'Inspect the latest or a specific Libris operation and its output paths'},
            {'cmd': '/libris approvals [auto|ask]', 'desc': 'Inspect or change read-only research source approvals'},
